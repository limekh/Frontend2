export namespace Transport {
    ...
    export class Car extends Vehicle implements ICar {
        ...
        public getShortInfo(): string {
            return `Тип кузова: ${this._bodyType}\nКласс автомобиля: ${this._carClass}`;
        }
    }
    ...
    export interface IVehicleStorage<T extends IVehicle> {
        ...
        sortByBrand(): T[];
        getVehicleByBrand(surname: string): T[];
    }
    ...
    export class VehicleStorage<T extends Vehicle> implements IVehicleStorage<T> {
        ...
        getVehicleByBrand(brand: string): T[] {
            return this.vehicles.filter(vehicle => vehicle.brand.toLocaleUpperCase() === brand.toUpperCase());
        }
